...
Use **Editar refeição** abaixo de um registro para mudar o relato, a data, os alimentos, as porções e as calorias. É possível adicionar/remover alimentos e conferir o total antes de salvar. **Recalcular pelo relato** solicita uma nova estimativa da IA; **Salvar correção** guarda os ajustes manuais, inclusive offline. Cancelar não altera o registro. Os totais diário e semanal acompanham as alterações, sem criar outra refeição.
